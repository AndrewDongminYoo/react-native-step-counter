...
Object.defineProperty(exports, "NAME", {
  enumerable: true,
  get: function () {
    return _NativeStepCounter.NAME;
  }
});
Object.defineProperty(exports, "VERSION", {
  enumerable: true,
  get: function () {
    return _NativeStepCounter.VERSION;
  }
});
exports.isSensorWorking = exports.default = void 0;
exports.isStepCountingSupported = isStepCountingSupported;
exports.parseStepData = parseStepData;
exports.startStepCounterUpdate = startStepCounterUpdate;
exports.stopStepCounterUpdate = stopStepCounterUpdate;
var _reactNative = require("react-native");
var _NativeStepCounter = require("./NativeStepCounter");
 ...
 */
const StepCounterModule = isTurboModuleEnabled ? require('./NativeStepCounter').default : _reactNative.NativeModules.StepCounter;
...
const StepEventEmitter = new _reactNative.NativeEventEmitter(StepCounter);
const isSensorWorking = exports.isSensorWorking = StepEventEmitter.listenerCount(_NativeStepCounter.eventName) > 0;
...
class UnavailabilityError extends Error {
  constructor(moduleName, propertyName) {
    super(`The method or property ${moduleName}.${propertyName} is not available on ${_reactNative.Platform.OS}, ` + "are you sure you've linked all the native dependencies properly?");
 ...
 */
function isStepCountingSupported() {
 ...
 * })
 */
function startStepCounterUpdate(start, callBack) {
  if (!StepCounter.startStepCounterUpdate) {
    throw new UnavailabilityError(_NativeStepCounter.NAME, _NativeStepCounter.eventName);
  }
  const from = start.getTime();
  StepCounter.startStepCounterUpdate(from);
  return StepEventEmitter.addListener(_NativeStepCounter.eventName, callBack);
}
 ...
 */
function stopStepCounterUpdate() {
  StepEventEmitter.removeAllListeners(_NativeStepCounter.eventName);
  StepCounter.stopStepCounterUpdate();
}
var _default = exports.default = StepCounter;
