...
class StepCounterModule(context: ReactApplicationContext) :
    ...
    companion object {
        ...
        const val ACCELERATOR = "com.stepcounter.services.AccelerometerService"
        const val STEPCOUNTER = "com.stepcounter.services.StepCounterService"
    }

    private var appContext: ReactApplicationContext?
    private var currentSteps: Double = 0.0
    private var stepService: SensorListenService?
    private var serviceIntent: Intent?
    private var stepsParamsMap: WritableMap? = null
