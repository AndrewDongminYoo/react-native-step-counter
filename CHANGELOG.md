...
- 🕐 **iOS timestamp unit safety**: Added a `from > 1e12` guard to auto-detect accidentally passed millisecond timestamps and convert them to seconds, plus a 60-second future-timestamp clamp to prevent sessions starting in the future. ([cd2491b](https://github.com/AndrewDongminYoo/react-native-step-counter/commit/cd2491b))
